...
import { Plus, Bell, User, LogOut, Menu, Trash2 } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="p-2 text-yellow-600 dark:text-yellow-400 hover:text-yellow-500 dark:hover:text-yellow-300"
          >
          ...
          <button
            ...
            className="relative p-2 text-yellow-600 dark:text-yellow-400 hover:text-yellow-500 dark:hover:text-yellow-300"
          >
        ...
        {showMobileMenu && (
          <div className="border-t border-yellow-200 dark:border-yellow-800">
            <div className="px-4 py-4 space-y-3">
              ...
              {user?.role === 'admin' && (
                <button
                  onClick={() => { handleDeleteOrphanedEquipment(); setShowMobileMenu(false); }}
                  disabled={isDeleting}
                  className="flex items-center space-x-3 w-full p-3 bg-yellow-100 dark:bg-yellow-900 dark:bg-opacity-50 border border-yellow-400 dark:border-yellow-600 text-red-500 dark:text-red-400 rounded-lg hover:bg-yellow-200 dark:hover:bg-opacity-70 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
